...
import { registerUserPet, uploadUserPetImage } from "../services/petService";
...
export default function RegisterPet() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Upload image if selected (using the new user pet image endpoint)
      ...
      // Create pet with final data
      await registerUserPet({
        ...formData,
    ...
    return (
      <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-gray-600 text-center mb-4">
          You need to be logged in to register your pet.
        </p>
        <div className="flex justify-center">
          <button
            onClick={() => navigate("/login?redirect=/register-pet")}
    ...
    <div className="max-w-3xl mx-auto page-transition">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600">
          Register your pet to book veterinary appointments
        </p>
      </div>
